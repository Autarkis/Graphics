...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public enum FrameSettingsField
    {
        ...
        VirtualTexturing = 68,
        /// <summary></summary>
        [FrameSettingsField(0, autoName: Ocean, customOrderInGroup: 106, tooltip: "")]
        Ocean = 99,
    ...
    partial struct FrameSettings
    {
        ...
        internal static void Sanitize(ref FrameSettings sanitizedFrameSettings, Camera camera, RenderPipelineSettings renderPipelineSettings)
        {
            ...
            sanitizedFrameSettings.bitDatas[(int)FrameSettingsField.Ocean] &= renderPipelineSettings.supportOcean && !preview;
